...
public class ShoppingCartManualTest {
    ...
    public static void run() {
        ...
        if (total5 == 255.0) {
            System.out.println("PASSED: Simple cart total is correct (255.0)");
            passedCount++;
        } else {
            System.out.println("FAILED: Simple cart total expected 255.0 but got " + total5);
            failedCount++;
        }
